...
### 2.1. /src/pages/Home.tsx 파일 생성

### 2.2. /src/pages/TodoReadPage.tsx 파일 생성
...
### 2.3. /src/pages/TodoWritePage.tsx 파일 생성
...
### 2.4. /src/pages/TodoEditPage.tsx 파일 생성
  ...
  if (!id) {
    return (
      <section className=" space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold">잘못된 ID 입니다.</h2>
          <NavLink to="/todos">목록으로</NavLink>
        </div>
      </section>
    );
  }
...
### 2.5. /src/pages/TodoDetailPage.tsx 파일 생성
...
### 2.6 . /src/pages/NotFound.tsx 파일 생성

### 2.7. /src/pages/Settings.tsx 파일 생성
