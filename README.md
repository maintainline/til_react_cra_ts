...
//2-5. reducer 함수 만들기 >>  타입 적용 (todoAction)
...
### 2.3. useMemo로 state 를 리랜더링에서 필요한 경우만 업데이트 하기
...
- /src/context/todo/`reducer.ts` 생성
...
- /src/context/todo/`TodoProvider.tsx` 생성
